defmodule Vocagraphy.Video do
  ...
  @primary_key {:id, Vocagraphy.Permalink, autogenerate: true}
  schema "videos" do
    field :url, :string
    field :title, :string
    ...
    has_many :annotations, Vocagraphy.Annotation, on_delete: :nilify_all
  ...
  defimpl Phoenix.Param, for: Vocagraphy.Video do
